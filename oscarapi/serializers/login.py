...
class RegisterUserSerializer(serializers.Serializer):
    ...
    company_dot = serializers.CharField()
    ...
    def create_user(self, email, password, account_type, company_name, company_dot, full_name, phone_number):
        ...
        return User.objects.create_user(username=email,
                                        ...
                                        company_name=company_name, company_dot=company_dot, full_name=full_name, phone_number=phone_number)
    ...
    def save(self):
        ...
        company_dot = self.validated_data['company_dot']

        full_name = self.validated_data['full_name']
        phone_number= self.validated_data['phone_number']
        # print(email,password)
        return self.create_user(email, password, account_type, company_name, company_dot, full_name, phone_number)
