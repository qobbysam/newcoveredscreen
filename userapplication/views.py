...
class DashHomeView(TemplateView):
    template_name = 'userapplication/dash.html'
...
class ConsortiumView(TemplateView):
    template_name = 'userapplication/consortium_index.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            company = UserCompanyModel.objects.get( id =  self.request.user.default_company)
